...
public class DatabaseMain {
    public static void main(String[] args) {
        ...
        // 그 이유는 뭘까요? -> DataManger.java에 DatabaseConnection 객체를 하나 만ㄷ르어 내느
        // 코드를 작성해 넣었기 때문에 굳이 반복하지 않습니다. (어차피 싱글톤 패턴이기도 하구요)
        DataManger dataManger1 = new DataManger();

        // dataManager1의 메서드 실행
        dataManger1.performDatabaseOperations();
        /*
            ...
            데이터베이스 연결을 끊었습니다.
         */
        // dataManager2 객체 생성하시고 performDatabaseOperations() 이거 실행시킨 결과를
        // 콘솔 창에 띄워두세요.

        DataManger dataManger2 = new DataManger();
        dataManger2.performDatabaseOperations();
        /*
            결과값
            데이터베이스 연산을 수행 중
            데이터베이스 연결을 끊었습니다.
