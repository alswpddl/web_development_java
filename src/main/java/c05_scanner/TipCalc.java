...
public class TipCalc {
    public static void main(String[] args) {
        ...
        /*
            ...
            ex)
            100,000원짜리 음식을 결제하고, 팁으로 10퍼센트를 준다면
...
//
//        System.out.print("음식 가격이 얼마인가요? >>> ");
//        foodPrice = scanner.nextInt();
//        System.out.print("몇 퍼센트의 팁을 낼 것인가요?  >>> ");
//        percent = scanner.nextInt();
//        // totalPrice를 연산하시오.
//        totalPrice = foodPrice + (foodPrice * percent / 100);
//        // percent / 100을 할 경우 0.1이 나오면 int가 아니라 double이기 때문에 연산 안됨
//
//        System.out.print("인원이 몇명인가요? >>> ");
...
//        System.out.println("1인당 지불해야 하는 금액은 " + pricePerPerson + "원 입니다.");
        ...
        String logo= """
                                                                                                              ...
                                                                                                              \s
                8888888 8888888888  8 8888 8 888888888o       ,o888888o.           .8.          8 8888        \s
                      8 8888        8 8888 8 8888    `88.    8888     `88.        .888.         8 8888        \s
                      8 8888        8 8888 8 8888     `88 ,8 8888       `8.      :88888.        8 8888        \s
                      8 8888        8 8888 8 8888     ,88 88 8888               . `88888.       8 8888        \s
                      8 8888        8 8888 8 8888.   ,88' 88 8888              .8. `88888.      8 8888        \s
                      8 8888        8 8888 8 888888888P'  88 8888             .8`8. `88888.     8 8888        \s
                      8 8888        8 8888 8 8888         88 8888            .8' `8. `88888.    8 8888        \s
                      8 8888        8 8888 8 8888         `8 8888       .8' .8'   `8. `88888.   8 8888        \s
                      8 8888        8 8888 8 8888            8888     ,88' .888888888. `88888.  8 8888        \s
                      8 8888        8 8888 8 8888             `8888888P'  .8'       `8. `88888. 8 888888888888\s
