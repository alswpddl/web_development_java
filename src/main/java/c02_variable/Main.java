...
//        System.out.println(checkFlag);
//        checkFlag2 = true;     //오류가 발생함을 의미
//        boolean checkFlag3;     // 변수 선언 -> 자료형 변수명;
//        checkFlag3 = true;      // 변수 값을 최초로 대입하는 것을 -> 초기화
        // 최초로 변수를 선어할 때 자료형(data type)을 명시하고 값을 대입하며 초기화함
...
//        EXAMPLE_OF_FINAL="이렇게 바꾸겠습니다.";   -> 오류 발생    // 상수의 재대입은 불가능 -> 3) 참조
        /*
            상수의 특징 :
            1) 개발자들끼리의 약속으로 상수는 전체 다 대문자로 작성하고, 단어사이의 경계를 '-'로 표시함.
            2) 한 번의 선언 및 초기화가 가능
            3) 2)를 이유로, 재대입이 불가능
         */
    }
