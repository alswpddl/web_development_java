...
/*
    인터페이스(interface)
        인터페이스는 자바에서 클래스가 구현해야 하는 '메서드'들의 집합을 정의하는 일종의 규약(protocal)
    ...
    특징
        ...
        2. 상수 : 인터페이스 내에서 선연된 변수는 '자동으로' public static final 상수로 취급됨.
    ...
    추상 클래스와의 차이점
       ...
       - 인터페이스
            ...
            5. 자동 public : 인터페이스의 메서들들은 자동으로 public이며, 메서드 선언에 접근 제어자를 명시할 수 있다.
                Java 8 이후에, default, static 메서드를 사용할 수 있긴 합니다.
 */
public class Main {
    public static void main(String[] args) {
        ...
        /*
            ...
            입력했을 경우 RemoteController.java 내부에 새엉자는
            ...
            구조를 이해하셔야 합니다!!!
            RemoteController의 객체를 생성했는데, 그 개게 이름이 remoteController입니다.
