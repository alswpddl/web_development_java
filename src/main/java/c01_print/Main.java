...
//    근데 그렇게 하려면 맨 앞으로 넘어가서 슬래쉬를 두 번 타이핑해야하는데 다른 방법이 뭐가 있을까? -> ctrl + /
    public static void main(String[] args) { //main입력
