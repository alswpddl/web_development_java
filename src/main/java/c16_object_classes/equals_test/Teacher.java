...
public class Teacher {
    ...
    public String toString() {
        return "Teacher{" + "name='" + name + '\'' + ", schoolName='" + schoolName + '\'' + '}';
    }
    ...
    // equals()는 주로 문자열끼리 동일한지를 확인하는 용도로 String클래스에서 많이 사용되지만 해당 메서드 역시
    // Object 클래스에서 overriding 받은
    // 것이다. -> 즉 String 클래스에서는 문자열끼리만 비교하는 용도로 '재정의' 함.
    @Override
