...
//
//        // 여러분들 이름과 나이를 constuctor1에 대입하겠습니다.
//        constructor1.num = 20;
...
//        scanner.nextLine();     // netInt() 쓰는 바람에 enter 누르면 넘어감 -> 배리어용 nextLine() 삽입
...
//        constructor4.num = 20;
//        System.out.println("constructor의 name은 " + constructor4.name + "이고\nnum은 " + constructor4.num + "입니다.");
