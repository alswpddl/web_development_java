...
/*
    ...
    여기서 기억해야 할 점은
    동일 method명이라 할지라도 어떤 클래스에 종속돼있냐에 따라서 다른 결과값을 가지고 옵니다.
    예시
...
//        System.out.println(Arrays.toString(arr2));
        ...
        System.out.println("오름 차순 정렬 후 배열 : " + Arrays.toString(arr3));

        // 내림차순 배열
        Arrays.sort(arr3, Comparator.reverseOrder());   // 마찬가지로 재대입하지 않아도 이미 내림차순 정리가 됨.
        // Comparator.reverseOeder() 메서드를 적용하기 위해서는 <T>가 요구되고, T는 클래스여야만 하기 때문에
