...
/*
    배열의 필요성 :
        여태까지의 숭버을 기주능로 하면 10개의 정수형 데이터를 저장하려면 int 변수를 10개 선언해서 저장해야 했습니다
        ...
        을 출력해보면 [I@36baf30c, [I@7a81197d와 같은 값이 출력되고 {1,2,3,4,5}와 깉은 방식으로 출력되지 않습니다.
        ...
        참조 변수 : 데이터가 위치한 주소값을 가지는 변수로 해당 주소를 통해서 데이터에 접근하여 값을 가져오거나 변경하는 경우
            String, 배열, 객체(클래스), Collections -> Collections은 추후 수업 예정
 */

public class ArrayTest01 {
    public static void main(String[] args) {
        int[] arr = new int[5];     // 배열 선언 방식 1 -> 배열을 선언만 하고 후에 값을 대입하는 형식
        // 비어있는 배열에 값을 대입하는 방식
        arr[0]=100;
        arr[1]=200;
        arr[2]=300;
...
//        }
        ...
        // 그렇다면 하교 전교생 혹은 재직자 숫자와 가이 명확하지 않은 배열에서 각 요소를 출력하기 위한 방법
        // arr 객체의 field인 length를 활용하여 컴퓨터가 알아서 배열의 크기를 찾아서 반복문을 통해 추력하도록 함
